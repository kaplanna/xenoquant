...
# === USER PARAMETERS ========================================
# ============================================================
WORKDIR_DEFAULT = Path("/home/marchandlab/DataAnalysis/Kaplan/training/2509_Signal_Plots/251021_PG_Refine_Plots/PG-Iters3")
XNA_DEFAULT     = "P"
CHROM           = "contig1"
LEVELS_TXT      = "/home/marchandlab/github/kaplanna/xemora/models/remora/9mer_10-4-1.tsv"
N_READS         = 5000
METRICS_FLANK   = 21  # independent flank length (bases) (21 for PZ & BS, 14 for DsPx due to short construct)
